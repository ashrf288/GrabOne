...
export default function EscapesDeals() {
  ...
  <Card style={{ width: '20rem',marginBottom:"2%" ,marginTop:"2%",textAlign:"left"}}className="col-sm-*" >
                <div className="container">
            <Card.Img variant="top" className="w-6 " src={ele.img} style={{display:"block",width:"20rem"}} />
            <Icon icon="tabler:heart-plus" className="loveIcon" width="30" onClick={()=>setIsShow(true)}/>
            ...
            <Card.Body>
              ...
              <Card.Text style={{marginLeft:"80%" , marginBottom:0 ,fontSize:"14px" ,color:"#01B2EE"}} >
                from
              </Card.Text>
